"""
实验B — E1 ladder 补足至 5 seeds（增 60 run）
E1 场景：6 bw × 5 policies × seeds [4,5] = 60 runs
...
from exp_v3_batch3_formal import (
    ...
    SCENARIOS, POLICIES, V4_TOLERANCE,
)

NEW_SEEDS = [4, 5]
SCENE_FILTER = ["E1"]  # Only E1 for this supplement


def main():
    print("=" * 80)
    print("实验B — E1 Ladder 5-seed 加固（seeds 4,5 补充）")
    print("=" * 80)
