...
PROJ       = _BASE
PIPE_DIR   = os.path.join(_BASE, "figure_pipeline")
FIG_REG    = os.path.join(PIPE_DIR, "data", "figure_registry")
E3_BASE    = os.path.join(PIPE_DIR, "data", "e3_swap")
ANCHOR_D   = os.path.join(PIPE_DIR, "data", "anchor")
